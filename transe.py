...
class TransE(nn.Module):
    ...
    def compute_distance(self, heads, relations, tails):
    ...
    def forward(self, positive_samples, negative_samples):
        ...
        pos_distances = self.compute_distance(pos_heads, pos_relations, pos_tails)
        neg_distances = self.compute_distance(neg_heads, neg_relations, neg_tails)
